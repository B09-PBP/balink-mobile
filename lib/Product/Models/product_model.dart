...
class Fields {
  ...
  factory Fields.fromJson(Map<String, dynamic> json) => Fields(
        name: json["name"],
        year:
            json["year"], // The year is already an int, so no need to parse it
        price: double.tryParse(json["price"]) ??
            0.0, // Ensure price is parsed as a double
...
enum Model { PRODUCT_PRODUCT }

final modelValues = EnumValues({"product.product": Model.PRODUCT_PRODUCT});
